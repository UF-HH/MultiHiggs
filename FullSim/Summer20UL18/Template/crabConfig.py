...
config.JobType.inputFiles  = ['scriptExe.sh', 'genSim_step.py','digiPremix_step.py','hlt_step.py','recoAOD_step.py','miniAOD_step.py','nanoAOD_step.py','NMSSM_XYH_YToHH_6b_MX_600_MY_400_slc6_amd64_gcc630_CMSSW_9_3_16_tarball.tar.xz']
...
config.Data.outLFNDirBase = '/store/user/srosenzw/XY_YToHH/'
