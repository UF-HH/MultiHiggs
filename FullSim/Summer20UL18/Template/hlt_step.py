...
# with command line options: --python_filename BTV-RunIISummer20UL18HLT-00016_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:BTV-RunIISummer20UL18HLT-00016.root --conditions 102X_upgrade2018_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2018v32 --geometry DB:Extended --filein file:BTV-RunIISummer20UL18DIGIPremix-00016.root --era Run2_2018 --no_exec --mc -n 42069

import os
expected_cmssw = 'CMSSW_10_2_16_UL'
