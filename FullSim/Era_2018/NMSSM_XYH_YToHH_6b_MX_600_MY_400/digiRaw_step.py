...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:genSim_step.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('digiRaw_step.py nevts:'+str(options.nEvents)),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:digiRaw_step.root'),
...
# Other statements
import random
from pileup import puListFull
random.shuffle(puListFull)
puList = puListFull[0:50]
