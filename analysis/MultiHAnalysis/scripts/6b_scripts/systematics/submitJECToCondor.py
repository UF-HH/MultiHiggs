...
# masses_to_run = ['MX-500_MY-250', 'MX-500_MY-300', 'MX-500_MY-350', 'MX-650_MY-500', 'MX-750_MY-350', 'MX-850_MY-500', 'MX-900_MY-500', 'MX-900_MY-700', 'MX-950_MY-500', 'MX-1000_MY-500', 'MX-1000_MY-600', 'MX-1100_MY-400', 'MX-1200_MY-600', 'MX-1200_MY-700']
# masses_to_run = ['MX-700_MY-300', 'MX-700_MY-350','MX-700_MY-400']
masses_to_run = ['MX-900_MY-700']
# masses_to_run = ['MX-1000_MY-500', 'MX-1100_MY-400', 'MX-1200_MY-600', 'MX-1200_MY-700', 'MX-500_MY-250', 'MX-500_MY-300', 'MX-500_MY-350', 'MX-650_MY-500', 'MX-750_MY-350', 'MX-850_MY-500', 'MX-900_MY-500', 'MX-900_MY-700', 'MX-950_MY-500']
...
for signal in signals:
   ...
   if submit_jer: 
      ...
      tag = f'Summer{year}UL/maxbtag_4b/Official_NMSSM/syst/JER{jer}/up'
      ...
      tag = f'Summer{year}UL/maxbtag_4b/Official_NMSSM/syst/JER{jer}/down'
   ...
   if submit_bjer: 
      ...
      tag = f'Summer{year}UL/maxbtag_4b/Official_NMSSM/syst/bJER/up'
      ...
      tag = f'Summer{year}UL/maxbtag_4b/Official_NMSSM/syst/bJER/down'
   ...
   if submit_syst:
      ...
      for syst in systematics:
         ...
         # if 'Relative' not in syst: continue
         # if syst != f'HF_{year}': continue
         # if syst != 'RelativeBal': continue
         # if syst != f'RelativeSample_{year}': continue
         # if syst != f'Absolute_{year}': continue
         # if syst != f'EC2_{year}': continue
         # if syst != f'EC2': continue
         # if syst != 'FlavorQCD': continue
         # if syst != 'Total': continue
         # if 'HF' not in syst: continue

         # up
         print(f"[INFO] Processing systematic: {Fore.CYAN}{syst}{Style.RESET_ALL}:up")
         tag = f'Summer{year}UL/maxbtag_4b/Official_NMSSM/syst/{syst}/up'
         # print(f"/eos/uscms/store/user/srosenzw/sixb/ntuples/{tag}/{signal}")
         # end()
         ...
         tag = f'Summer{year}UL/maxbtag_4b/Official_NMSSM/syst/{syst}/down'
