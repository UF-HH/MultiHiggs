...
with open("data/jec/2017/RegroupedV2_Summer19UL17_V5_MC_UncertaintySources_AK4PFchs.txt") as f:
   output = f.read()
...
input_dir = 'input/Run2_UL/RunIISummer20UL17NanoAODv9/NMSSM_XToYHTo6B'
cmd = f'ls {input_dir}'
...
# try: subprocess.run("rm -r /eos/uscms/store/user/srosenzw/sixb/ntuples/Summer2017UL/maxbtag_4b/Official_NMSSM/syst/*/*/analysis_tar", shell=True)
# except: pass
...
for signal in signals:
   ...
   tag = f'Summer2017UL/maxbtag_4b/Official_NMSSM/syst/JER{jer}/up'
   ...
   tag = f'Summer2017UL/maxbtag_4b/Official_NMSSM/syst/JER{jer}/down'
   ...
   tag = f'Summer2017UL/maxbtag_4b/Official_NMSSM/syst/bJER/up'
   ...
   tag = f'Summer2017UL/maxbtag_4b/Official_NMSSM/syst/bJER/down'
   ...
   for syst in systematics:
      ...
      tag = f'Summer2017UL/maxbtag_4b/Official_NMSSM/syst/{syst}/up'
      ...
      tag = f'Summer2017UL/maxbtag_4b/Official_NMSSM/syst/{syst}/down'
