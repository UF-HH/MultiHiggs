...
for input in ${files[@]}; do
    ...
    python scripts/submitSkimOnSlurm.py --tag $TAG --outputDir $ODIR --cfg $CFG --njobs 100 --input $input --is-signal --forceOverwrite --memory 4000
